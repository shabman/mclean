...
pattern_formatter::pattern_formatter(std::string       pattern,
    ...
    : pattern_(std::move(pattern)), eol_(std::move(eol)), pattern_time_type_(time_type),
      need_localtime_(false), last_log_secs_(0), custom_handlers_(std::move(custom_user_flags))
{
...
SPDLOG_INLINE void
pattern_formatter::set_pattern(std::string pattern)
{
...
SPDLOG_INLINE void
pattern_formatter::need_localtime(bool need)
{
