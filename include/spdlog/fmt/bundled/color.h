...
FMT_CONSTEXPR inline auto
operator|(emphasis lhs, emphasis rhs) noexcept -> text_style
{
...
template <typename Char>
FMT_CONSTEXPR auto
make_foreground_color(color_type foreground) noexcept -> ansi_color_escape<Char>
{
...
template <typename Char>
FMT_CONSTEXPR auto
make_background_color(color_type background) noexcept -> ansi_color_escape<Char>
{
...
template <typename Char>
inline void
reset_color(buffer<Char>& buffer)
{
...
inline void
vprint(FILE* f, text_style ts, string_view fmt, format_args args)
{
...
template <typename... T>
void
print(FILE* f, text_style ts, format_string<T...> fmt, T&&... args)
{
...
template <typename... T>
void
print(text_style ts, format_string<T...> fmt, T&&... args)
{
    return print(stdout, ts, fmt, std::forward<T>(args)...);
}

inline auto
vformat(text_style ts, string_view fmt, format_args args) -> std::string
{
    auto buf = memory_buffer();
    detail::vformat_to(buf, ts, fmt, args);
...
template <typename... T>
inline auto
format(text_style ts, format_string<T...> fmt, T&&... args) -> std::string
{
...
auto
vformat_to(OutputIt out, text_style ts, string_view fmt, format_args args) -> OutputIt
{
...
inline auto
format_to(OutputIt out, text_style ts, format_string<T...> fmt, T&&... args) -> OutputIt
{
