...
template <typename Mutex>
SPDLOG_INLINE filename_t
rotating_file_sink<Mutex>::filename()
{
...
template <typename Mutex>
SPDLOG_INLINE void
rotating_file_sink<Mutex>::rotate_now()
{
    std::lock_guard<Mutex> lock(base_sink<Mutex>::mutex_);
    rotate_();
}
template <typename Mutex>
SPDLOG_INLINE void
rotating_file_sink<Mutex>::set_max_size(std::size_t max_size)
{
    std::lock_guard<Mutex> lock(base_sink<Mutex>::mutex_);
    if (max_size == 0)
    {
...
template <typename Mutex>
SPDLOG_INLINE std::size_t
              rotating_file_sink<Mutex>::get_max_size()
{
    std::lock_guard<Mutex> lock(base_sink<Mutex>::mutex_);
    return max_size_;
}
...
template <typename Mutex>
SPDLOG_INLINE void
rotating_file_sink<Mutex>::set_max_files(std::size_t max_files)
{
    std::lock_guard<Mutex> lock(base_sink<Mutex>::mutex_);
    if (max_files > MaxFiles)
    {
...
template <typename Mutex>
std::size_t
rotating_file_sink<Mutex>::get_max_files()
{
    std::lock_guard<Mutex> lock(base_sink<Mutex>::mutex_);
    return max_files_;
}
...
template <typename Mutex>
SPDLOG_INLINE void
rotating_file_sink<Mutex>::rotate_()
{
