    ...
    struct invoke_params
    {
        invoke_params(int             max_lines,
            ...
            : max_lines(max_lines), q_text_edit(q_text_edit), payload(std::move(payload)),
              default_color(default_color), level_color(level_color),
              color_range_start(color_range_start), color_range_end(color_range_end)
        {
        }
        int             max_lines;
        QTextEdit*      q_text_edit;
...
qt_logger_mt(const std::string& logger_name,
             QTextEdit*         qt_object,
...
template <typename Factory = spdlog::synchronous_factory>
inline std::shared_ptr<logger>
qt_logger_st(const std::string& logger_name,
             QTextEdit*         qt_object,
             const std::string& meta_method = "append")
{
...
template <typename Factory = spdlog::synchronous_factory>
inline std::shared_ptr<logger>
qt_color_logger_mt(const std::string& logger_name,
...
template <typename Factory = spdlog::synchronous_factory>
inline std::shared_ptr<logger>
qt_color_logger_st(const std::string& logger_name,
                   QTextEdit*         qt_text_edit,
                   int                max_lines,
                   bool               is_utf8 = false)
{
