...
SPDLOG_INLINE spdlog::log_clock::time_point
              now() SPDLOG_NOEXCEPT
{
...
SPDLOG_INLINE std::tm
              localtime(const std::time_t& time_tt) SPDLOG_NOEXCEPT
{
#ifdef _WIN32
    std::tm tm;
...
SPDLOG_INLINE std::tm
              gmtime(const std::time_t& time_tt) SPDLOG_NOEXCEPT
{
#ifdef _WIN32
    std::tm tm;
    ::gmtime_s(&tm, &time_tt);
...
SPDLOG_INLINE int
remove(const filename_t& filename) SPDLOG_NOEXCEPT
{
...
SPDLOG_INLINE int
remove_if_exists(const filename_t& filename) SPDLOG_NOEXCEPT
{
...
SPDLOG_INLINE bool
path_exists(const filename_t& filename) SPDLOG_NOEXCEPT
{
#ifdef _WIN32
    struct _stat buffer;
#ifdef SPDLOG_WCHAR_FILENAMES
...
SPDLOG_INLINE int
utc_minutes_offset(const std::tm& tm)
{
#ifdef _WIN32
...
SPDLOG_INLINE void
sleep_for_millis(unsigned int milliseconds) SPDLOG_NOEXCEPT
{
#if defined(_WIN32)
    ::Sleep(milliseconds);
#else
...
SPDLOG_INLINE bool
is_color_terminal() SPDLOG_NOEXCEPT
{
#ifdef _WIN32
    return true;
#else
...
SPDLOG_INLINE bool
in_terminal(FILE* file) SPDLOG_NOEXCEPT
{
#ifdef _WIN32
...
SPDLOG_INLINE void
wstr_to_utf8buf(wstring_view_t wstr, memory_buf_t& target)
{
...
SPDLOG_INLINE void
utf8_to_wstrbuf(string_view_t str, wmemory_buf_t& target)
{
...
static SPDLOG_INLINE bool
mkdir_(const filename_t& path)
{
#ifdef _WIN32
#ifdef SPDLOG_WCHAR_FILENAMES
...
// Return true on success.
SPDLOG_INLINE bool
fwrite_bytes(const void* ptr, const size_t n_bytes, FILE* fp)
{
